...
class ImportRegistrations extends Command
{
     ...
     * @var string
     */
    protected $description = 'Importa informações do cadastro florestal do SGF';
    ...
    public function handle()
    {
        ...
        foreach (Storage::files('forest') as $filename) {
            $this->output->title('Starting import file: '.$filename);
            if(is_file($path.$filename)){
                (new RegistrationsImport)->withOutput($this->output)->import($path.$filename);
