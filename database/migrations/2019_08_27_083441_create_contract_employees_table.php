...
class CreateContractEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contract_employees', function (Blueprint $table) {
            ...
            $table->bigInteger('person_employee_id')->unsigned();
            ...
            $table->unique(['contract_id','person_employee_id']);
            $table->foreign('contract_id')->references('id')->on('contracts')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('person_employee_id')->references('id')->on('person_employees')->onDelete('restrict')->onUpdate('cascade');
